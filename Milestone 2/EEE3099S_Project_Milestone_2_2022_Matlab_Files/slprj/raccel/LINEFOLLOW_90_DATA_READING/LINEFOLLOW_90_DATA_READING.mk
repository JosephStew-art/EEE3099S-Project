...
MAKECMD         = /Applications/MATLAB.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = LINEFOLLOW_90_DATA_READING
MODULES                 = rt_matrx.c rt_printf.c LINEFOLLOW_90_DATA_READING.c LINEFOLLOW_90_DATA_READING_capi.c LINEFOLLOW_90_DATA_READING_data.c LINEFOLLOW_90_DATA_READING_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c raccel_sfcn_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = LINEFOLLOW_90_DATA_READING
MAKEFILE                = LINEFOLLOW_90_DATA_READING.mk
MATLAB_ROOT             = /Applications/MATLAB.app
ALT_MATLAB_ROOT         = /Applications/MATLAB.app
START_DIR               = /Users/josephstewart/Desktop/Github/EEE3099S-Project/Milestone\ 2/EEE3099S_Project_Milestone_2_2022_Matlab_Files
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
COMPUTER                = MACI64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/Applications/MATLAB.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=1 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.15"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB.app/bin/maci64 -Wl,-rpath,/Applications/MATLAB.app/sys/os/maci64 -Wl,-rpath,@executable_path -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB.app/sys/os/maci64
INTERLEAVED_COMPLEX_FLAGS = -R2018a
DEFINES_CUSTOM          = -DEXT_MODE -DIS_RAPID_ACCEL -DRACCEL_ENABLE_PARALLEL_EXECUTION -DRACCEL_PARALLEL_EXECUTION_NUM_THREADS=8 -DRACCEL_NUM_PARALLEL_NODES=2 -DRACCEL_PARALLEL_SIMULATOR_TYPE=0 
DEFINES_OTHER           = -DHAVESTDIO
COMPILE_FLAGS_OTHER     = -msse2
SYSTEM_LIBS             = -L"/Applications/MATLAB.app/bin/maci64" -lmwipp -lut -lmx -lmex -lmat -lmwmathutil -lmwslsa_sim -lmwslexec_simbridge -lmwsl_fileio -lmwsigstream -lmwsl_AsyncioQueue -lmwsl_services -lmwsdi_raccel -lmwi18n -lmwcoder_target_services -lmwcoder_ParamTuningTgtAppSvc -lmwslpointerutil -lmwsl_simtarget_instrumentation -lmwsl_sfcn_loader -lmwslexec_parallel -lfixedpoint -lmwslexec_simlog -lmwstringutil -lm -lpthread -ldl
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/LINEFOLLOW_90_DATA_READING \
...
raccel_sfcn_utils.o : $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_sfcn_utils.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_sfcn_utils.c
